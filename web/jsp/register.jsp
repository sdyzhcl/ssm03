...
<script type="text/javascript" src="<%=path%>/static/js/me/logout.js"></script>
			...
			<form id="regForm" method="post" action="<%=path%>/user/register">
				<table>
					<tr>
						...
						<td><input id="userName" class="text" type="text" name="userName"
					...
					<tr>
						...
						<td ><input type="radio" name="sex"  style="border:0px;" checked="checked"
									value="0" />男
							<input type="radio" name="sex" style="border:0px;" value="1"/>
							女<span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input class="text verycode" type="text" name="veryCode"
								   onfocus="FocusItem(this)" onblur="CheckItem(this);" />
							<img id="veryCode" src="<%=path%>/authImg"/><span></span></td>
					</tr>
					<tr>
						<td></td>
